...
- Trong một hệ thống ngân hàng:
	- Một người cùng một lúc click thực hiện 2 transaction trừ tiền
		- 2 giai đoạn: select và update
	- Tài khoản có 1.000.000 và thực hiện giao dịch trừ 700.000, điều kiện thực hiện giao dịch thành công là tài khoản > 700.000
	- Đối với for share: khi select 2 transaction vẫn đồng thời hiện 1.000.000 nhưng khi update transaction 2 vẫn đợi transaction 1 thực hiện xong rồi mới thực hiện nên tài khoản sẽ còn 300.000
