...
created: 2026-06-02
description: "One simple but game-changing insight I had about database query performance was realizing how fundamental the number of sequential and random reads is to the way databases choose query plans, because sequential reads are (far) cheaper than random ones. This difference is easier to grasp if you think"
tags:
  - "clippings"
---
